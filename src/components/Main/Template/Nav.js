  ...
  <section id="sidebar">
    ...
    <section className="blurb">
      ...
      <ul className="actions">
        <li>
          {window.location.pathname !== `${`/react-resume`}/resume` ? <Link to="/resume" className="button">Learn More</Link> : <Link to="/about" className="button">About Me</Link>}
        </li>
      </ul>
    </section>
